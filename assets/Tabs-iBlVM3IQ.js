import{d as ee,h as c,v as L,aS as ut,aT as ye,aU as vt,aV as ht,ad as Q,aW as gt,k as xt,q as Pe,aB as mt,a3 as yt,aX as wt,O as St,N as Ct,t as Rt,y as Z,aY as Tt,l as r,m as i,o as S,n as T,p as $t,aZ as ne,aq as we,a_ as oe,z as zt,A as We,a$ as Pt,b0 as Se,w as Wt,ap as ie,$ as _t,F as Et,x as j,b1 as At,aI as Lt,D as I,b2 as K,aF as Bt,E as kt,ax as jt,b3 as It,b4 as Ht,b5 as Ot,ao as se,H as J}from"./index-CAuj7ceO.js";import{A as Ft}from"./Add-a8GTv_U1.js";const Dt=ye(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ye("&::-webkit-scrollbar",{width:0,height:0})]),Mt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const s=ut();return Dt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:vt,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...d){var m;(m=e.value)===null||m===void 0||m.scrollTo(...d)}})},render(){return c("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Vt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Xt=/^\s+/;function Ut(e){return e&&e.slice(0,Vt(e)+1).replace(Xt,"")}var Ce=NaN,Gt=/^[-+]0x[0-9a-f]+$/i,Yt=/^0b[01]+$/i,qt=/^0o[0-7]+$/i,Kt=parseInt;function Re(e){if(typeof e=="number")return e;if(ht(e))return Ce;if(Q(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Q(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var s=Yt.test(e);return s||qt.test(e)?Kt(e.slice(2),s?2:8):Gt.test(e)?Ce:+e}var le=function(){return gt.Date.now()},Jt="Expected a function",Zt=Math.max,Qt=Math.min;function ea(e,n,s){var u,d,m,v,f,x,h=0,g=!1,_=!1,E=!0;if(typeof e!="function")throw new TypeError(Jt);n=Re(n)||0,Q(s)&&(g=!!s.leading,_="maxWait"in s,m=_?Zt(Re(s.maxWait)||0,n):m,E="trailing"in s?!!s.trailing:E);function y(b){var R=u,F=d;return u=d=void 0,h=b,v=e.apply(F,R),v}function $(b){return h=b,f=setTimeout(W,n),g?y(b):v}function C(b){var R=b-x,F=b-h,U=n-R;return _?Qt(U,m-F):U}function P(b){var R=b-x,F=b-h;return x===void 0||R>=n||R<0||_&&F>=m}function W(){var b=le();if(P(b))return z(b);f=setTimeout(W,C(b))}function z(b){return f=void 0,E&&u?y(b):(u=d=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=d=f=void 0}function A(){return f===void 0?v:z(le())}function p(){var b=le(),R=P(b);if(u=arguments,d=this,x=b,R){if(f===void 0)return $(x);if(_)return clearTimeout(f),f=setTimeout(W,n),y(x)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=O,p.flush=A,p}var ta="Expected a function";function de(e,n,s){var u=!0,d=!0;if(typeof e!="function")throw new TypeError(ta);return Q(s)&&(u="leading"in s?!!s.leading:u,d="trailing"in s?!!s.trailing:d),ea(e,n,{leading:u,maxWait:n,trailing:d})}const fe=xt("n-tabs"),_e={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},sa=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:_e,slots:Object,setup(e){const n=Pe(fe,null);return n||mt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return c("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),aa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Tt(_e,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:aa,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:d,tabStyleRef:m,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:_,handleAdd:E,activateTab:y,handleClose:$}=Pe(fe);return{trigger:_,mergedClosable:Z(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?d.value:C}),style:m,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&$(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:W}=g;W?Promise.resolve(W(e.name,s.value)).then(z=>{z&&h.id===P&&y(C)}):y(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:d,tab:m,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=d??m;return c("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?c("div",{class:`${n}-tabs-tab-pad`}):null,c("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},yt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),c("span",{class:`${n}-tabs-tab__label`},e?c(St,null,c("div",{class:`${n}-tabs-tab__height-placeholder`}," "),c(Ct,{clsPrefix:n},{default:()=>c(Ft,null)})):h?h():typeof g=="object"?g:wt(g??s)),f&&this.type==="card"?c(Rt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ra=r("tabs",`
